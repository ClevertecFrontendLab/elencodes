...
const DessertsIcon = createIcon({
    displayName: 'DessertsIcon',
    path: (
        <>
            <rect width='24' height='24' fill='url(#pattern0_7123_15060)' />
            <defs>
                <pattern
                    id='pattern0_7123_15060'
                    patternContentUnits='objectBoundingBox'
                    width='1'
                    height='1'
                >
                    <use
                        xlinkHref='#image0_7123_15060'
                        transform='translate(0.125 0.125) scale(0.0078125)'
                    />
                </pattern>
                <image
                    id='image0_7123_15060'
                    width='96'
                    height='96'
